...
(()=>{
    const e = new Error("Cannot find module '../assets/logo.png'");
...
const Header = ()=>{
    ...
    if ($[0] !== "78c0313e3f40eaf096c3265e430fa8abe75a7f79b2dde4899f7e0d3d2e5976bb") {
        for(let $i = 0; $i < 15; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "78c0313e3f40eaf096c3265e430fa8abe75a7f79b2dde4899f7e0d3d2e5976bb";
    }
    ...
    const navLinks = t2;
    const t3 = `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-background/98 backdrop-blur-sm border-b border-border py-3" : "bg-transparent py-5"}`;
    let t4;
    ...
    const t7 = `md:hidden absolute top-full left-0 right-0 bg-background border-b border-border transition-all duration-300 ${isMenuOpen ? "opacity-100 visible" : "opacity-0 invisible"}`;
    let t8;
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
            ...
            children: [
                navLinks.map((link_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                        href: link_0.href,
...
//# sourceMappingURL=src_app_73453c3d._.js.map